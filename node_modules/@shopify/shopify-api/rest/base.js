...
var types_1 = require("../lib/clients/http_client/types");
var Base = /** @class */ (function () {
    ...
    Base.request = function (_a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                client = new this.CLIENT({ session: session });
    ...
    Base.getPath = function (_a) {
        ...
        this.PATHS.forEach(function (path) {
            ...
            match = path.path.replace(/(<([^>]+)>)/g, function (_m1, _m2, id) { return "".concat(pathUrlIds[id]); });
        });
        if (!match) {
    ...
    Base.prototype.request = function (args) {
