...
function begin(config) {
    ...
    return function (_a) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var log, cleanShop, request, cookies, state, query, processedQuery, redirectUrl, response;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    response = {
                        statusCode: 302,
                        statusText: 'Found',
                        headers: tslib_1.__assign(tslib_1.__assign({}, cookies.response.headers), { Location: redirectUrl }),
                    };
