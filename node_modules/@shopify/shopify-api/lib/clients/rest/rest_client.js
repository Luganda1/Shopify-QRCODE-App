...
var RestClient = /** @class */ (function (_super) {
    ...
    function RestClient(params) {
        ...
        if (!_this.restClass().CONFIG.isPrivateApp && !params.session.accessToken) {
    ...
    RestClient.prototype.getRequestPath = function (path) {
        ...
        if (cleanPath.startsWith('/admin')) {
            ...
            return "/admin/api/".concat(this.restClass().CONFIG.apiVersion).concat(cleanPath.replace(/\.json$/, ''), ".json");
        }
    };
