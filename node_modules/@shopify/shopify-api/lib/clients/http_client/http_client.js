            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        userAgent = "Shopify API Library v".concat(version_1.SHOPIFY_API_LIBRARY_VERSION, " | ").concat((0, platform_1.abstractRuntimeString)());
                        ...
                        if (params.method === network_1.Method.Post || params.method === network_1.Method.Put) {
                            type = (_a = params.type) !== null && _a !== void 0 ? _a : types_2.DataType.JSON;
                            data = params.data;
                            if (data) {
                                switch (type) {
                                    case types_2.DataType.JSON:
                                        body = typeof data === 'string' ? data : JSON.stringify(data);
                                        break;
                                    case types_2.DataType.URLEncoded:
                                        body =
                                            typeof data === 'string'
                                                ? data
                                                : new URLSearchParams(data).toString();
                                        break;
                                    case types_2.DataType.GraphQL:
                                        body = data;
                                        break;
                                }
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, crypto_1.createSHA256HMAC)(this.httpClass().CONFIG.apiSecretKey, JSON.stringify(deprecation), types_1.HashFormat.Hex)];
                    case 2:
                        depHash = _b.sent();
